...
![img](./.sharding-sphere.assets/362d22168bf344687ec0c206aa115807.jpg)
...
![image-20220804223138651](./.sharding-sphere.assets/image-20220804223138651.png)
...
- 在实际设计过程中，每个系统不可能只处理一种数据，而是包含多种类型的数据，`有的数据必须选择 CP，有的数据必须选择 AP，分布式系统理论上不可能选择 CA 架构。`
  ...
  ![img](./.sharding-sphere.assets/6e7d7bd54d7a4eb67918080863d354d7.png)
...
![img](./.sharding-sphere.assets/2ccafe41de9bd7f8dec4658f004310d6.png)
...
![img](./.sharding-sphere.assets/71f41d46cc5c0405f4d4dc944b4350c9.jpg)

下图展示了根据业务需要，将用户表和订单表垂直分片到不同的数据库的方案：

![image-20220804221855449](./.sharding-sphere.assets/image-20220804221855449.png)
...
![img](./.sharding-sphere.assets/136bc2f01919edcb8271df6f7e71af40.jpg)
...
![image-20220804222212087](./.sharding-sphere.assets/image-20220804222212087.png)
...
![image-20220804223321167](./.sharding-sphere.assets/image-20220804223321167.png)
...
![img](./.sharding-sphere.assets/f8d538f9201e3ebee37dfdcd1922e9df.jpg)
...
![img](./.sharding-sphere.assets/2a2dba7f07581fd055d9cd5a3aa8388e.jpg)
...
![image-20220804195402870](./.sharding-sphere.assets/image-20220804195402870.png)
...
![image-20220804195432673](./.sharding-sphere.assets/image-20220804195432673.png)

## 第03章 MySQL主从同步

### 1、MySQL主从同步原理

![img](./.sharding-sphere.assets/image-20220714133617856.png)
...
![image-20220807183231101](./.sharding-sphere.assets/image-20220807183231101.png)
...
![img](./.sharding-sphere.assets/0.08703112216569037.png)
...
![image-20220804191852164](./.sharding-sphere.assets/image-20220804191852164.png)
...
![img](./.sharding-sphere.assets/image-20220715000533951.png)
...
![img](./.sharding-sphere.assets/image-20220714235426120.png)
...
![img](./.sharding-sphere.assets/image-20220715004850504.png)
...
![image-20220807232456342](./.sharding-sphere.assets/image-20220807232456342.png)
...
![image-20220810163534068](./.sharding-sphere.assets/image-20220810163534068.png)
...
![image-20220808033239206](./.sharding-sphere.assets/image-20220808033239206.png)
...
![image-20220819152009158](./.sharding-sphere.assets/image-20220819152009158.png)
...
![image-20220819151154763](./.sharding-sphere.assets/image-20220819151154763.png)
